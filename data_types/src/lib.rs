/// Returns the type name for a value at runtime.
///
/// # Examples
///
/// ```
/// assert_eq!(data_types::type_of(42), "i32");
/// assert_eq!(data_types::type_of(42.0), "f64");
/// assert_eq!(data_types::type_of("abc"), "&str");
/// ```
...
mod types {
    ...
    fn type_inference() {
        ...
        assert_eq!(type_of(42.0), "f64");
        assert_eq!(type_of("a string"), "&str");
    }
    ...
    fn type_annotations() {
        ...
        assert_eq!(type_of(parsed_integer_with_annotation), "u32");
    }
}
...
mod scalar_types {
    ...
    fn integer_types() {
        ...
        assert_eq!(type_of(default_integer), "i32");
    }
    ...
    fn floating_point_types() {
        ...
        assert_eq!(type_of(default_float), "f64");
    }
